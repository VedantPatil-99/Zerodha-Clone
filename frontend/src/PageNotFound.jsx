	...
	return (
		<>
			<div className="holder section-spacing">
				<div className="flex flex-col md:flex-row justify-between items-center holder gap-1 font-semibold text-zinc-600">
					<div className="left md:w-1/2">
						<h2 className="text-2xl mb-4">404</h2>
						<h3 className="text-5xl mb-6">Kiaan couldn’t find that page</h3>
						<h4 className="text-xl font-normal leading-8 my-4">
