const SmallprintsFooter = () => {
	return (
		<div className="text-xs text-neutral-400 leading-5 mt-6 mb-4">
			<p className="mb-2.5">
				...
				<a href="mailto:complaints@zerodha.com" className="text-sky-700">
					complaints@zerodha.com
				</a>
				, for DP related to{" "}
				<a href="mailto:dp@zerodha.com" className="text-sky-700">
					dp@zerodha.com
				</a>
...
export default SmallprintsFooter;
